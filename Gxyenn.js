...
async function sendClearChat(target, GxyennInstance) {
    ...
    try {
        await GxyennInstance.sendMessage(target, { text: longText });
...
module.exports = async (Gxyenn, m) => {
  ...
  const Reply = async (text) => {
    await Gxyenn.sendMessage(from, { text: text }, { quoted: msg });
  };
...
Silakan hubungi owner jika ada pertanyaan atau kendala.`,
      ...
      case ".listprem":
        ...
        Gxyenn.sendMessage(from, { text: `📦 *DAFTAR PENGGUNA PREMIUM:*\n\n${premList}`, mentions: prem }, { quoted: msg });
        break;
      ...
      case ".listowner":
        ...
        Gxyenn.sendMessage(from, { text: `👑 *DAFTAR SEMUA OWNER BOT:*\n\n${teksO}`, mentions: listO }, { quoted: msg });
        break;
    }
  }
};
